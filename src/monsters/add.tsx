        ...
        <Sheet>
          ...
          <SheetContent className="p-4">
            ...
            <SheetDescription className="text-xl sr-only">
              ...
              the monster type and level, and the sheet will automatically calculate the monster's
              stats based on the selected level. You can also add any special abilities or
              characteristics that the monster may have. Once you have filled out all the necessary
              information, click the "Add Monster" button to add the monster to the game. The new
              monster will be added to the list of active monsters, and you can start using it in
